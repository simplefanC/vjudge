...
<html>
    <head>
        <title>Add Contest - Virtual Judge</title>
...
<%--         <script type="text/javascript" src="${contextPath}/javascript/contest_edit.js?<%=application.getAttribute("version")%>"></script> --%>
    ...
    <body>
        ...
        <form id="form" action="${contextPath}/contest/addContest.action" method="post" enctype="multipart/form-data">
        ...
        <div id="div_left" style="float:left:position:absolute;top:0;left:0">
            <table class="blue_border" style="border:1px solid #A6C9E2;border-collapse:collapse;width:545px">
                ...
                <tr>
                    ...
                    <td class="form_value">
                        <s:textfield name="_beginTime" size="18" readonly="true" >
                            <s:param name="value">
                ...
                <tr class="real_contest_element" style="display:none">
                    ...
                    <td class="form_value">
                        ...
                        <font color="green">Leave blank to make it public<font color="green">
                    </td>
                </tr>
                ...
                <tr class="real_contest_element">
                    ...
                    <td class="form_value">
                        <s:radio name="contest.enableTimeMachine" list="#{'0':'Disable', '1':'Enable'}" value="1" />
                    </td>
                </tr>
                <tr>
