 ...
 * 例如HDU
 *
 * 原作者 名为 CanonicalSubmitter 典范
 * @author Isun
 */
public abstract class ComplexSubmitter implements Submitter {
    private final static Logger log = LoggerFactory.getLogger(ComplexSubmitter.class);
